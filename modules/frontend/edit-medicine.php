    ...
    <div class="authenticate-bg">
        ...
        <div class="custom-center">
            <div class="rounded-card container square-box d-flex justify-content-center align-items-center">
                ...
                <form method="POST" action="../backend/update-medicine.php?id=<?php echo $_GET['id'] ?>">
                    ...
                    <div class=" row mb-2">
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="2" name="uses"
                                required><?php echo $uses ?></textarea>
                        </div>
                        <div class="col-md-6">
                            ...
                            <textarea class="form-control" id="exampleFormControlTextarea2" rows="2" name="sideeffects"
                                required><?php echo $sideeffects ?></textarea>
                        </div>
                    </div>
                    <div class="mb-2">
                        <label for="exampleFormControlTextarea3">Dosage</label>
                        <textarea class="form-control" id="exampleFormControlTextarea3" rows="3" name="dosage"
                            required><?php echo $dosage ?></textarea>
                    </div>
                    <div class="mb-2">
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-6">
                            <button type="button" class="btn btn-danger"
                                onclick="window.location.href='../backend/delete-medicine.php?id=<?php echo $_GET['id'] ?>'">Delete
                                Medicine
                                Info</button>
                        </div>
                    </div>
